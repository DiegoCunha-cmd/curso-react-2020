                ...
                <form id="formProduto" onSubmit={this.onSubmit}>
                    {this.state.sucesso &&
                        <div className="alert alert-dismissible alert-success">
                            ...
                            <strong>É isso aí!!!</strong> Procedimento realizado <a href="#" className="alert-link">O produto foi cadastrado com sucesso!</a>.
                        </div>
                    }
                        ...
                        this.state.errors.map( msg =>{
                            return(
                                <div className="alert alert-dismissible alert-danger">
                                    <button type="button" className="close" data-dismiss="alert">&times;</button>
                                    <strong>Erro</strong> Impossível cadastrar <a href="#" className="alert-link">{msg}</a>.
                                </div>
                            )                        
                        })
                    }
